                ...
                <div class="container">
                    ...
                    <div class="container">
                        ...
                        <ul class="list-group list-group-horizontal d-flex flex-wrap" id="items">
                            ...
                            <li class="list-group-item col-xl-3 col-lg-4 col-6 flex-fill">
                                <div class="product">
                                    <div class="product-image mb-md-3">
                                        <div class="product-badge badge badge-primary">Últimas unidades</div><a
                                            href="detail-1.html"><img class="img-fluid"
                                    ...
                                    <div class="position-relative">
                                        <h3 class="text-base mb-1"><a class="text-dark" href="detail-1.html">Cadeira
                                                Eames branca</a></h3>
                                        <span class="text-gray-800 text-sm">R$160.00</span><br><span
                                            class="text-gray-500 text-sm"><del>R$229.99</del></span>
                            ...
                            <li class="list-group-item col-xl-3 col-lg-4 col-6 flex-fill">
                                <div class="product">
                                    <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid"
                                                src="https://d19m59y37dris4.cloudfront.net/varkala/1-2-1/img/product/chair3-sq.jpg"
                                                alt="product" /></a>
                                        <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                                                <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                                                    <use xlink:href="#retail-bag-1"> </use>
                                    ...
                                    <div class="position-relative">
                                        <h3 class="text-base mb-1"><a class="text-dark" href="detail-1.html">Cadeira
                                                padrão vermelha</a>
                                        </h3><span class="text-gray-800 text-sm">R$199.99</span>
                                        <div class="product-stars text-xs"><i class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-muted"></i><i class="fa fa-star text-muted"></i>
                            ...
                            <li class="list-group-item col-xl-3 col-lg-4 col-6 flex-fill">
                                <div class="product">
                                    <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid"
                                                src="https://d19m59y37dris4.cloudfront.net/varkala/1-2-1/img/product/clock3.jpg"
                                                alt="product" /></a>
                                        <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                                                <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                                                    <use xlink:href="#retail-bag-1"> </use>
                                    ...
                                    <div class="position-relative">
                                        <h3 class="text-base mb-1"><a class="text-dark" href="detail-1.html">Relógio de
                                                parede
                                                minimalista</a></h3><span class="text-gray-800 text-sm">R$79.90</span>
                                        <div class="product-stars text-xs"><i class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-muted"></i><i class="fa fa-star text-muted"></i>
                            ...
                            <li class="list-group-item col-xl-3 col-lg-4 col-6 flex-fill">
                                <div class="product">
                                    <div class="product-image mb-md-3"><a href="detail-1.html"><img class="img-fluid"
                                                src="https://d19m59y37dris4.cloudfront.net/varkala/1-2-1/img/product/box2-sq.jpg"
                                                alt="product" /></a>
                                        <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                                                <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                                                    <use xlink:href="#retail-bag-1"> </use>
                                    ...
                                    <div class="position-relative">
                                        <h3 class="text-base mb-1"><a class="text-dark" href="detail-1.html">Caixa de
                                                acessórios roxa</a>
                                        </h3><span class="text-gray-800 text-sm">R$39.99</span>
                                        <div class="product-stars text-xs"><i class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-muted"></i><i class="fa fa-star text-muted"></i>
                            ...
                            <li class="list-group-item col-xl-3 col-lg-4 col-6 flex-fill">
                                <div class="product">
                                    <div class="product-image mb-md-3">
                                        <div class="product-badge badge badge-secondary">Novo</div><a
                                            href="detail-1.html"><img class="img-fluid"
                                                src="https://d19m59y37dris4.cloudfront.net/varkala/1-2-1/img/product/chair2-2.jpg"
                                                alt="product" /></a>
                                        <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                                                <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                                                    <use xlink:href="#retail-bag-1"> </use>
                                    ...
                                    <div class="position-relative">
                                        <h3 class="text-base mb-1"><a class="text-dark" href="detail-1.html">Cadeira
                                                Eames preta</a></h3>
                                        <span class="text-gray-800 text-sm">R$229.99</span>
                                        <div class="product-stars text-xs"><i class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-primary"></i><i
                                                class="fa fa-star text-muted"></i><i class="fa fa-star text-muted"></i>
                            ...
                            <li class="list-group-item col-xl-3 col-lg-4 col-6 flex-fill">
                                <div class="product">
                                    <div class="product-image mb-md-3">
                                        <div class="product-badge badge badge-dark">Esgotado</div><a
                                            href="detail-1.html"><img class="img-fluid"
                                                src="https://d19m59y37dris4.cloudfront.net/varkala/1-2-1/img/product/box.jpg"
                                                alt="product" /></a>
                                        <div class="product-hover-overlay"><a class="text-dark text-sm" href="#">
                                                <svg class="svg-icon text-hover-primary svg-icon-heavy d-sm-none">
                                                    <use xlink:href="#retail-bag-1"> </use>
                            ...
                            <div class="d-flex align-items-center"><a href="detail-1.html"><img
                                ...
                                <div class="w-100"><a class="close" href="#">
                                    ...
                                    <div class="pl-3"> <a class="navbar-cart-product-link text-dark link-animated"
                                            href="detail-1.html">Cadeira Eames branca</a><small
                                            class="d-block text-muted">Quantidade: 1
                                        </small><span class="text-gray-500 text-sm"><del>R$229.99</del></span><strong
                                            class="d-block text-sm">R$160.00 </strong></div>
                                </div>
                            </div>
                        </div>
                        <!-- cart item-->
                        <div class="navbar-cart-product">
                            <div class="d-flex align-items-center"><a href="detail-1.html"><img
                                ...
                                <div class="w-100"><a class="close" href="#">
                                    ...
                                    <div class="pl-3"> <a class="navbar-cart-product-link text-dark link-animated"
                                            href="detail-1.html">Cadeira padrão vermelha</a><small
                                            class="d-block text-muted">Quantidade: 1
                                        </small><strong class="d-block text-sm">R$199.99 </strong></div>
                                </div>
                            </div>
                        </div>
                        <!-- cart item-->
                        <div class="navbar-cart-product">
                            <div class="d-flex align-items-center"><a href="detail-1.html"><img
                                ...
                                <div class="w-100"><a class="close" href="#">
                                    ...
                                    <div class="pl-3"> <a class="navbar-cart-product-link text-dark link-animated"
                                            href="detail-1.html">Caixa de acessórios amarela</a><small
                                            class="d-block text-muted">Quantidade:
                                            1 </small><strong class="d-block text-sm">R$39.99 </strong></div>
                                </div>
                            </div>
                        </div>
                        <!-- cart item-->
                        <div class="navbar-cart-product">
                            <div class="d-flex align-items-center"><a href="detail-1.html"><img
                                ...
                                <div class="w-100"><a class="close" href="#">
                                    ...
                                    <div class="pl-3"> <a class="navbar-cart-product-link text-dark link-animated"
                                            href="detail-1.html">Caixa de acessórios</a><small
                                            class="d-block text-muted">Quantidade: 1
                                        </small><strong class="d-block text-sm">R$39.99</strong></div>
                                </div>
                            </div>
                        </div>
                        <!-- cart item-->
                        <div class="navbar-cart-product">
                            <div class="d-flex align-items-center"><a href="detail-1.html"><img
                                ...
                                <div class="w-100"><a class="close" href="#">
                                    ...
                                    <div class="pl-3"> <a class="navbar-cart-product-link text-dark link-animated"
                                            href="detail-1.html">Cadeira Eames preta</a><small
                                            class="d-block text-muted">Quantidade: 1
                                        </small><strong class="d-block text-sm">R$229.99 </strong></div>
                                </div>
                            </div>
                        </div>
                        <!-- cart item-->
                        <div class="navbar-cart-product">
                            <div class="d-flex align-items-center"><a href="detail-1.html"><img
                                ...
                                <div class="w-100"><a class="close" href="#">
                                    ...
                                    <div class="pl-3"> <a class="navbar-cart-product-link text-dark link-animated"
                                            href="detail-1.html">Relógio de parede minimalista</a><small
                                            class="d-block text-muted">Quantidade: 1 </small><strong
                                            class="d-block text-sm">R$79.90 </strong>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body px-5 pb-5">
                    <div>
                        <h5 class="mb-5" data-aos-delay="50">Aikia</h5>
                        <ul class="nav flex-column mb-5">
                            <li class="nav-item active"><a class="nav-link pl-0" href="index.php">Página inicial </a>
                            </li>
                        ...
                        <ul class="list-inline mb-4">
                            ...
                            <li class="list-inline-item mr-2">
                                ...
                                </svg> <a href="tel: 020-800-456-747">020-800-456-747</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="tab-pane fade px-3" id="loginModalTabRegister" role="tabpanel"
                            ...
                            <form action="customer-orders.html" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="registerTel" type="tel" required>
                                    <small class="form-text text-muted">Formato: (11)55555-5555</small>
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="registerPassword">Senha</label>
                                    <input class="form-control" id="registerPassword" type="password" required>
                                </div>
                                <div class="form-group text-center">
                                    <button class="btn btn-block btn-outline-dark" type="button"
                                        onclick="registerValidate()"><i class="far fa-user mr-2"></i>Cadastrar
                                    </button>
                                </div>
                            </form>
